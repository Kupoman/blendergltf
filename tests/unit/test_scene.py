def test_scene_default(exporters, state, bpy_scene_default, gltf_scene_default):
    output = exporters.SceneExporter.export(state, bpy_scene_default)
...
def test_scene_custom_props(exporters, state, bpy_scene_default):
