...
class TestMeshUtils(unittest.TestCase):
    def test_extract_attributes_basic(self):
        ...
        self.assertEqual(list(attrs['indices'][0]), [[0, 2, 1]])
    ...
    def test_material_splitting(self):
        ...
        self.assertEqual(len(list(all_indices[0])), 1)
        self.assertEqual(len(list(all_indices[1])), 1)
